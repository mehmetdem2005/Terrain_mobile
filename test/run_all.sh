...
echo "==> 6/8 path safety unit test (TKT-002 C1 regression)"
...
echo "==> 7/8 brush system unit test (TKT-002 C4 regression)"
...
echo "==> 8/8 splatmap system unit test (TKT-003 Phase A.1 extraction)"
