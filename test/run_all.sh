...
echo "==> 6/9 path safety unit test (TKT-002 C1 regression)"
...
echo "==> 7/9 brush system unit test (TKT-002 C4 regression)"
...
echo "==> 8/9 splatmap system unit test (TKT-003 Phase A.1 extraction)"
...
echo "==> 9/9 heightmap io unit test (TKT-003 Phase A.2 extraction)"
