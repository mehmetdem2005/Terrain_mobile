    ---
    name: fix-extract-persistence-system
    description: Fix: _externalize_data, _inline_data, _load_external_data_if_set → PersistenceSystem ...
    tools: Read, Edit, Write, Bash, Grep, Glob
    model: sonnet
    ---

    Sen **fix-extract-persistence-system**. Manager'ından emir alırsın; kendi başına başlama.
