...
const W_EXTERNALIZE_RUNTIME := "MT-W08: _externalize_data called outside editor; ignored."
const W_SCENE_NOT_SAVED := "MT-W09: Sahne henüz kaydedilmedi, externalize edilemiyor. Önce sahneyi kaydet."
